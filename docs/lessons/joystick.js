/* ============================================================================
   ...
   Wiring facts this depends on, from docs/extension-board.md and README.md:
     ...
     - the module's own leg order is recorded in docs/modules/joystick.md — it
    ...
    },
    {
      ...
      steps: [
        { k: 'module', row: 'E', p0: 44, n: 5, pins: ['SW', 'VRy', 'VRx', '+5V', 'GND'],
          ...
          coach: 'Pin names are printed on the back of the module — check them before trusting this order. This is the order for the module this build was wired against (recorded in docs/modules/joystick.md); a different unit may read +5V, GND, SW, VRx, VRy instead, and every wire below would need to shift with it. VRx gets a leg but no wire; it is simply not used in this build.' },
